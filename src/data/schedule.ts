...
export const schedules: DaySchedule[] = [
  {
    ...
    overview: { ko: '제주 공항 도착 후 렌트카·공항 합류. 숙소 체크인 후 흑돼지 취사.', ja: '済州空港到着後、合流してチェックイン。夕食は黒豚焼肉。' },
    timeline: [
      ...
      { time: '14:00', content: { ko: '제주 공항 도착', ja: '済州空港 到着' }, groups: ['sister_family'], highlight: true },
      { time: '14:30', content: { ko: '김포 출발 (TW719)', ja: '金浦出発 (TW719)' }, groups: ['parents'] },
      { time: '15:00', content: { ko: '아이오닉9 렌트카 수령', ja: 'IONIQ9 レンタカー受取' }, groups: ['parents'], highlight: true },
      { time: '15:45', content: { ko: '제주 공항 도착', ja: '済州空港 到着' }, groups: ['parents'], highlight: true },
      { time: '15:45', content: { ko: '부모님 제주 도착 / 아이오닉9 합류', ja: '両親 済州到着 / IONIQ9 合流' }, groups: ['sister_family'], highlight: true },
