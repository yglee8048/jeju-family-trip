...
export const hotelPrograms: HotelProgram[] = [
  ...
  // 키즈 & 패밀리 프로그램
  {
    ...
    desc: { ko: '숨겨진 보물을 찾고, 다양한 지형지물을 넘나들며 미션을 해결하는 등 다채로운 탐험 놀이를 진행합니다.', ja: '隠れた宝を探し、さまざまな地形を越えてミッションをこなす多彩な探検あそびを行います。' },
    time: '10:00 - 17:30',
    days: '매일',
  ...
  },
  {
    ...
    desc: { ko: '자연과 아이들이 서로 친밀해질 수 있도록 자연의 재료를 더한 놀이를 제안합니다.', ja: '自然と子どもたちが親しめるよう、自然の素材を取り入れた遊びを提案します。' },
    time: '14:00 - 17:30',
    days: null,
    location: { ko: 'Re Play Kids Club (3F)', ja: 'Re Play Kids Club (3F)' },
    period: '~ 3월31일',
  ...
  },
  {
    ...
    desc: { ko: '자연의 재료들을 더해 나만의 작품을 탄생시키는 시간, 작품을 만들며 자연의 소중함을 일깨워봅니다.', ja: '自然の素材を使って自分だけの作品を作る時間。制作を通じて自然の大切さに気づきます。' },
    time: '10:00 - 11:00',
    days: null,
    location: { ko: 'Re Play Kids Club (3F)', ja: 'Re Play Kids Club (3F)' },
    period: '~ 3월31일',
  ...
  },
  {
    ...
    desc: { ko: '뛰고, 구르고, 던지는 다양한 움직임으로 신체 유연성과 대근육 발달을 돕고 운동 자신감을 키웁니다.', ja: '走る・転がる・投げるなど多様な動きで身体の柔軟性と大筋肉の発達を促し、運動への自信を育てます。' },
    time: '11:00 - 12:30',
    days: null,
    location: { ko: 'Re Play Kids Club (3F)', ja: 'Re Play Kids Club (3F)' },
    period: '~ 3월31일',
  ...
  },
  {
    ...
    desc: { ko: '초록빛 제주의 숲을 탐색합니다. 순수한 호기심과 열정을 발산해 자연에서 즐거움을 경험합니다.', ja: '緑豊かな済州の森を探索。純粋な好奇心と情熱を発揮して自然の中で喜びを体験します。' },
    time: '14:00 - 15:30',
    days: null,
    location: { ko: 'Re Play Kids Club (3F)', ja: 'Re Play Kids Club (3F)' },
    period: '~ 3월31일',
  ...
  },
  {
    ...
    desc: { ko: '제주 계절 식재료와 JW 가든에서 수확한 신선 채소로 재밌는 요리 수업을 진행합니다.', ja: '済州の旬の食材とJWガーデンで収穫した新鮮野菜を使った楽しいお料理教室です。' },
    time: '16:00 - 17:30',
    days: null,
    location: { ko: 'Re Play Kids Club (3F)', ja: 'Re Play Kids Club (3F)' },
    period: '~ 3월31일',
  ...
  },
  {
    ...
    desc: { ko: '가족이 함께 모여 도란도란 이야기 나누고, 해녀 드림캐쳐 만들기 등 손수 작품을 만들어 봅니다. 투숙 기간 중 1회 참여 가능. 성인 보호자 1인 동반 필수.', ja: '家族が集まり、語り合いながら海女のドリームキャッチャー作りなど手作り体験をします。滞在中1回参加可。保護者同伴必須。' },
    time: '18:00 - 18:30',
    days: null,
    location: { ko: 'Re Play Kids Club (3F)', ja: 'Re Play Kids Club (3F)' },
    period: '~ 3월31일',
  ...
  // 대여 프로그램
  {
    ...
    desc: { ko: '프리미엄 골프 브랜드 젝시오의 최신형 클럽 대여. 1인 1세트, 최대 주 2회 / 1일 1회, 당일 반납. 문의: 064-803-7773', ja: 'プレミアムゴルフブランドXXIOの最新クラブレンタル。1人1セット、週最大2回/1日1回、当日返却。問い合わせ: 064-803-7773' },
    time: null,
    days: null,
  ...
  },
  {
    ...
    desc: { ko: '닌텐도, 보드게임(부루마블·우봉고·루미큐브), 스포츠 용품(배드민턴·캐치볼·훌라후프) 대여. 선착순, 당일 반납. 문의: 064-803-7773', ja: 'ニンテンドー、ボードゲーム（ブルーマーブル・ウボンゴ・ルミキューブ）、スポーツ用品（バドミントン・キャッチボール・フラフープ）レンタル。先着順、当日返却。問い合わせ: 064-803-7773' },
    time: '10:00 - 19:00',
    days: null,
    location: { ko: 'Re Play Kids Club (3F)', ja: 'Re Play Kids Club (3F)' },
    period: '~ 3월31일',
